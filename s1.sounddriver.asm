...
PSGA:		binclude "sound/psg/psgA.bin"
PSGB:		binclude "sound/psg/psgB.bin"
PSGC:		binclude "sound/psg/psgC.bin"
PSGD:		binclude "sound/psg/psgD.bin"
...
SoundPriorities:
        ...
        dc.b $80,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90,$90    ; $D0 -- Pay attention to this row
...
; Music data
; ---------------------------------------------------------------------------
Music81:	binclude "sound/music/Azure Lake Zone.bin"
		even
Music82:	binclude "sound/music/LagoonCityAmy.bin"
		even
Music83:	binclude "sound/music/Street.bin"
		even
Music84:	include "sound/music/ChromeGadget.asm"
		even
Music85:	binclude "sound/music/Genocide Night Reimagined.bin"
		even
Music86:	binclude "sound/music/Granada - Nature Trail.bin"
		even
Music87:	binclude "sound/music/Sonic 3 PC - Super Sonic.bin"
		even
Music88:	binclude "sound/music/Sonic & Knuckles - Extra Life.bin"
		even
Music89:	binclude "sound/music/Sonic 3D Blast - Special Stage.bin"
		even
Music8A:	binclude  "sound/music/Dark City Title S1.bin"
		even
Music8B:	binclude "sound/music/Mean Bean Machine - Staff Roll.bin"
		even
Music8C:	binclude "sound/music/011_ToP_135.bin"
		even
Music8D:	binclude "sound/music/Big Arms.bin"
		even
Music8E:	binclude "sound/music/Go Ahead.bin"
		even
Music8F:	binclude "sound/music/Sonic Spinball - Game Over Beta.bin"
		even
Music90:	include "sound/music/NoWay.asm"
		even
Music91:	binclude "sound/music/Sonic 3 PC - Credits.bin"
		even
Music92:	include "sound/music/Mus92 - Drowning.asm"
		even
Music93:	include "sound/music/Mus93 - Get Emerald.asm"
		even
Music94:	binclude "sound/music/Endless Mine.bin"
		even
Music95:	include "sound/music/Stage58Intro.asm"
		even
Music96:	binclude "sound/music/Modern Cyber City 2024.bin"
		even
Music97:	binclude "sound/music/Google Doodle - Champion Island Theme SMPS.bin"
		even
Music98:	binclude "sound/music/Sonic 3D Blast - Unused Special Stage Tune.bin"
		even
Music99:	include "sound/music/PCM_Test.asm"
		even
; ---------------------------------------------------------------------------
...
; Sound effect data
; ---------------------------------------------------------------------------
SoundA0:	include "sound/sfx/SonicCDJump.asm"
		even
