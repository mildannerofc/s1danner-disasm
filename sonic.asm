;  =========================================================================
; |          Sonidanner Disassembly (Purish Engine by Mildanner)            |
;  =========================================================================
;
; Original disassembly created by Hivebrain
; GitHub Sonic 1 Disassembly by Sonic Retro
; Mega PCM 2 fork by Vladikcomper
...
loc_E0:
		...
		dc.b "SONIDANNER THE          HEDGEHOG                " ; Domestic name
		dc.b "SONIDANNER THE          HEDGEHOG                " ; International name
		if Revision=0
...
Tit_LoadText:
		...
		move.w	#$420,(v_demolength).w ; run title screen for $178 frames
...
Tit_ChkLevSel:
		...
		bsr.w	PlaySound_Special ; play options music
...
LevelMenuText:   if Revision=0
    dc.b    "ACID ISLAND ZONE   ACT 1"
        dc.b    "                   ACT 2"
        dc.b    "                   ACT 3"
        dc.b    "MYSTIC MAZE ZONE   ACT 1"
        dc.b    "                   ACT 2"
        dc.b    "                   ACT 3"
        dc.b    "MT FIRE ZONE       ACT 1"
        dc.b    "                   ACT 2"
        dc.b    "                   ACT 3"
        dc.b    "CYBER CITY ZONE    ACT 1"
        dc.b    "                   ACT 2"
        dc.b    "                   ACT 3"
        dc.b    "GOLDEN YARD ZONE   ACT 1"
        dc.b    "                   ACT 2"
        dc.b    "                   ACT 3"
        dc.b    "EGG FACTORY ZONE   ACT 1"
        dc.b    "                   ACT 2"
        dc.b    "                   ACT 3"
        dc.b    "FINAL ZONE              "            
        dc.b    "SPECIAL STAGE           "          
...
M_Card_GHZ:	spriteHeader		; GREEN HILL
	spritePiece	$B0, -8, 2, 2, $00, 0, 0, 0, 0
	spritePiece	$C0, -8, 2, 2, $08, 0, 0, 0, 0
	spritePiece	$D0, -8, 1, 2, $20, 0, 0, 0, 0
	spritePiece	$D8, -8, 2, 2, $0C, 0, 0, 0, 0
	spritePiece	$F8, -8, 1, 2, $20, 0, 0, 0, 0
	spritePiece	$00, -8, 2, 2, $3E, 0, 0, 0, 0
	spritePiece	$10, -8, 2, 2, $26, 0, 0, 0, 0
	spritePiece	$20, -8, 2, 2, $00, 0, 0, 0, 0
	spritePiece	$30, -8, 2, 2, $2E, 0, 0, 0, 0
	spritePiece	$40, -8, 2, 2, $0C, 0, 0, 0, 0

M_Card_GHZ_End
	even

M_Card_LZ:	spriteHeader		; LABYRINTH
	spritePiece	$AB, -8, 2, 2, $2A, 0, 0, 0, 0
	spritePiece	$BC, -8, 2, 2, $4A, 0, 0, 0, 0
	spritePiece	$CC, -8, 2, 2, $3E, 0, 0, 0, 0
	spritePiece	$DC, -8, 2, 2, $42, 0, 0, 0, 0
	spritePiece	$EC, -8, 1, 2, $20, 0, 0, 0, 0
	spritePiece	$F4, -8, 2, 2, $08, 0, 0, 0, 0
	spritePiece	$14, -8, 2, 2, $2A, 0, 0, 0, 0
	spritePiece	$25, -8, 2, 2, $0, 0, 0, 0, 0
	spritePiece	$35, -8, 2, 2, $4E, 0, 0, 0, 0
	spritePiece	$45, -8, 2, 2, $10, 0, 0, 0, 0
M_Card_LZ_End
	even

M_Card_MZ:	spriteHeader		; MARBLE
	spritePiece	 $CB, -8, 2, 2, $2A, 0, 0, 0, 0
	spritePiece  $DC, -8, 2, 2, $42, 0, 0, 0, 0
	spritePiece	 $FC, -8, 2, 2, $14, 0, 0, 0, 0
	spritePiece	 $0C, -8, 2, 2, $20, 0, 0, 0, 0
	spritePiece	 $14, -8, 2, 2, $3A, 0, 0, 0, 0
	spritePiece	 $24, -8, 2, 2, $10, 0, 0, 0, 0
	
M_Card_MZ_End
	even

M_Card_SLZ:	spriteHeader		; STAR LIGHT
	spritePiece	$B4, -8, 2, 2, $08, 0, 0, 0, 0
	spritePiece	$C4, -8, 2, 2, $4A, 0, 0, 0, 0
	spritePiece	$D4, -8, 2, 2, $04, 0, 0, 0, 0
	spritePiece	$E4, -8, 2, 2, $10, 0, 0, 0, 0
	spritePiece	$F4, -8, 2, 2, $3A, 0, 0, 0, 0
	; space
	spritePiece	$14, -8, 2, 2, $08, 0, 0, 0, 0
	spritePiece	$24, -8, 1, 2, $20, 0, 0, 0, 0
	spritePiece	$2C, -8, 2, 2, $42, 0, 0, 0, 0
	spritePiece	$3C, -8, 2, 2, $4A, 0, 0, 0, 0
M_Card_SLZ_End
	even

M_Card_SYZ:	spriteHeader		; GOLDEN YARD
	spritePiece	-$5C, -8, 2, 2, $18, 0, 0, 0, 0 ; G
	spritePiece	-$4C, -8, 2, 2, $32, 0, 0, 0, 0 ; O
	spritePiece	-$3C, -8, 2, 2, $26, 0, 0, 0, 0 ; L
	spritePiece	-$2C, -8, 2, 2, $0C, 0, 0, 0, 0 ; D
...
M_Card_SBZ:	spriteHeader		; SCRAP BRAIN
	spritePiece	$A0, -8, 2, 2, $10, 0, 0, 0, 0
	spritePiece	$B0, -8, 2, 2, $18, 0, 0, 0, 0
	spritePiece	$C0, -8, 2, 2, $18, 0, 0, 0, 0
	spritePiece	$E0, -8, 2, 2, $14, 0, 0, 0, 0
	spritePiece	$F0, -8, 2, 2, $32, 0, 0, 0, 0
	spritePiece	$00, -8, 2, 2, $3A, 0, 0, 0, 0
	spritePiece	$10, -8, 2, 2, $42, 0, 0, 0, 0
	spritePiece	$20, -8, 2, 2, $3A, 0, 0, 0, 0
	spritePiece	$30, -8, 2, 2, $10, 0, 0, 0, 0
	spritePiece	$40, -8, 2, 2, $3E, 0, 0, 0, 0
	spritePiece	$50, -8, 2, 2, $3E, 0, 0, 0, 0
M_Card_SBZ_End
	even
